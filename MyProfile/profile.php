...
<html>
    <head>
        <title>Description du profile</title>
        <meta charset="UTF-8">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row col-sm-12">
                        <div class="col-md-8 left_bloc">
                            ...
                            <div class="col-md-offset-1 col-md-6 header-profile">
                                <p>
                                <h3>RAIMI F.Gerard</h3><br>
                                <h5>Poste actuel: Chef comptable</h5> <br>
                                <h5>Niveau d'étude: BAC + 5</h5><br>
                                <h5>Espérience professionelle: 4 ans</h5><br>
                                <font color='skyblue'><h5>Contact: +229 97096632 /steevenraimi@gmail</h5></font>
                                </p>
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="col-md-12 description-profile">
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                                </p>
                                <p>
